...
### Bước 1 — Brand kit SEONGON (màu cố định)

Sử dụng bộ màu thương hiệu SEONGON đã xác định, **không cần fetch website**:

| Biến | Mã màu | Tỷ lệ | Dùng cho |
|------|--------|--------|----------|
| `PRIMARY` | `#004aef` | 70% | Màu chủ đạo — header, button, tiêu đề |
| `LIGHT` | `#0dd1ff` | 20% | Accent phụ — cột highlight, border, glow |
| `ACCENT` | `#ffce00` | 10% | Điểm nhấn — tag timeline, dot SEONGON trên map |
...
- [ ] Màu brand SEONGON áp dụng đúng: PRIMARY `#004aef` · LIGHT `#0dd1ff` · ACCENT `#ffce00`
