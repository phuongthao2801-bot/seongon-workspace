...
### Bước 1 — Xác nhận đối thủ + load dữ liệu nền
> **Load on demand:** Đọc `doi-thu.md` để xem danh sách đối thủ đã biết và lịch sử phân tích trước đó.
...
> **Load on demand:** Đọc `template.md` để lấy khung phân tích chuẩn, điền data thật vào.
